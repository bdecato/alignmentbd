/**
 *   lalignbd -- Local alignment tool: Identifies the optimal local
 *   alignment between two sequence fragments.
 *
 ...
 */
static void lalignbd(vector<vector<matrix_node> > &matrix, string &s1,
...
int main(int argc, const char **argv) {
    ...
    lalignbd(matrix, s1, s2, match, mismatch, indel);
